...
subplot(plots,nrows=5, shareX = T, titleX = F) %>%
  layout(title = list(text = "<br><b>Casos nuevos por región</b></br>Media móvil de 7 días",
                      font = list(size = 24,
                                  color="white")),
         annotations = list(
...
subplot(plots, nrows = 5, shareX = T, titleX = F,shareY=T) %>%
  layout(title = list(text = "<br><b>Casos nuevos por millón de hab. por región</b></br>Media móvil de 7 días",
                      font = list(size = 24,
                                  color = "white")),
         annotations = list(
           list(text = "<b>Fecha de reporte</b>",
