...
annot <- list(list(text = "<i>Fallecidos</i>",font=list(color="white"),
                   x=0.2, y=0.965, 
                   xref='paper', yref='paper', showarrow=FALSE,
                   xanchor="center",yanchor="top"))
...
plot_ly(marker=list(line=list(width=1, color="black")),
  ...
  add_trace(z=log(c.dep$pas),
            ...
            colorbar= list(thicknes=20,
                           ...
                           tickfont= list(color="white"),
                           tickmode="array",
                           tickvals=c(min(log(c.dep$pas)),max(log(c.dep$pas))*0.25,
                                      max(log(c.dep$pas))*0.5,max(log(c.dep$pas))*0.75,
                                      max(log(c.dep$pas))),
                           ticktext= c("0","1","10","100","1,000+")),
            hoverinfo="text",
...
plot_ly(marker=list(line=list(width=1, color="black")),
  ...
  add_trace(z=c.dep$pas.new.log,
            ...
            colorbar= list(thicknes=20,
                           ...
                           tickfont= list(color="white"),
                           tickmode="array",
                           tickvals=c(min(c.dep$pas.new.log),max(c.dep$pas.new.log)*0.25,
                                      max(c.dep$pas.new.log)*0.75,max(c.dep$pas.new.log)),
                           ticktext= c("0","1","10","100+")),
            hoverinfo="text",
            text = paste(c.dep$dep,'<br><b>Fallecidos nuevos:</b></br>',c.dep$pas.new)
  )%>% 
