...
```{r, message=F, warning=F}
 nac %>%
  ...
  layout(title = '<b>Casos nuevos y acumulados - Perú</b>',
         ...
         annotations = list(
           list(text = "Muestra los casos nuevos por día (barras) y casos acumulados (línea naranja) en escala lineal a nivel nacional. La escala lineal sirve para visualizar la suma contínua de casos.",
                x = 0,
                y = -0.1,
                yref = "paper",
                xref = "paper",
