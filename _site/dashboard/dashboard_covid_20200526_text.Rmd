...
<html lang="en">
  ...
  <head>
    ...
    <title>
			CE4 - Dashboard COVID-19
		&nbsp;| Repositorio CE4</title>
...
})(window,document,'script','dataLayer','GTM-M2Z3KQS');</script>
<!-- End Google Tag Manager -->
	<link rel="icon" type="media/png" href="/assets/media/Favicon/favicon-16x16.png" sizes="16x16">
	<link rel="icon" type="media/png" href="/assets/media/Favicon/favicon-32x32.png" sizes="32x32">
	<link rel="icon" type="media/png" href="/assets/media/Favicon/favicon-96x96.png" sizes="96x96">
  ...
  <body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a target="_blank" class="navbar-brand" href="https://www.cayetano.edu.pe/"><img src="/assets/media/upch-logo-blanco.png"  class="logo" title="Consorcio en Epidemiología y Ecología Espacial de Enfermedades - CE4" /></a>
				<a class="navbar-brand text" href="https://ce4-peru.github.io">Repositorio CE4</a>
			</div>
	...
	<ul class="nav navbar-nav">
			...
			<li >
				<a href="/proyectos/covid19/">COVID-19</a>
			</li>
...
```{r, message=F, warning=F}
 nac %>%
  ...
  layout(title = '<b>Casos nuevos y acumulados - Perú</b>',
         ...
         annotations = list(
           list(text = "Muestra los casos nuevos por día (barras) y casos acumulados (línea naranja) en escala lineal a nivel nacional. 
                <br>La escala lineal sirve para visualizar la suma contínua de casos.</br>",
                x = -0.08,
                y = -0.19,
                yref = "paper",
                xref = "paper",
...
14 de Mayo de 2020 - Lanzamiento 
	...
	<div class="row">
		<div class="col-sm-4">
			<div class="wrapper">
				<p>Consorcio en Epidemiología y Ecología Espacial de Enfermedades</p>
			</div>
		</div>
		<div class="col-sm-4">
			<div class="wrapper">
				<a style="color: #000; text-decoration: none;" href="https://twitter.com/tropicalesupch" target="_blank">
					<img class="social twitter" src="/assets/media/twitter_social.svg" title="Síguenos en twitter" /> 
						Síguenos en twitter
				</a>
			</div>
			<div class="wrapper">
				<a style="color: #000; text-decoration: none;" href="https://github.com/ce4-peru/ce4-peru.github.io" target="_blank">
					<img class="social twitter" src="/assets/media/Octicons-mark-github.svg" title="Colabora en GitHub" /> 
						Colabora en GitHub
				</a>
			</div>
		</div>
		<div class="col-sm-4">
			<div class="wrapper">
				<a target="_blank" href="https://www.cayetano.edu.pe/">
					<img src="/assets/media/upch-logo.png" title="Universidad Peruana Cayetano Heredia"/>
				</a>
			</div>
		</div>
	</div>
