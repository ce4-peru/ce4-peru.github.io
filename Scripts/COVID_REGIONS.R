...
caso_covid <- fread("~/covid19PE-LIEZ/data/crudas/covidPE_ IND_20200327_MD.csv")
...
levels(pob_region$REGION) # todo ok
...
# eliminando los unos de la ecuacion ( mika code)
# region_values$incidencia <- region_values$NUMERO_CASOS[1]/region_values$POBLACION[1]
...
print(qtm)
# tmap_save(qtm, 
#           paste("outputs_covid19/20202703_Dep_COVID19_Incidencerate_v2",".png", sep=""), 
#         width=2300, height=1380)


# Loop para plotear por dia
unique(sort(caso_covid$Fecha))
...
pdf("outputs_covid19/20200327_Dep_Incidencerate.pdf", onefile = TRUE)
